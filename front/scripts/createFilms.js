...
function handlerSubmit(event){
    ...
    const genreSelected = validateCheckbox()

    if(![title.value, year.value, director.value, duration.value, rate.value, poster.value].every(Boolean) || !genreSelected) {
        console.log("faltan llenar campos");
        return alert('Faltan llenar campos')
    }
    console.log("se envio");
    return alert('Pelicula creada')
}
